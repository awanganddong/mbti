...
Page({
  ...
  onLoad() {
    registerShareMenu();
    const pack = wx.getStorageSync("depdLastResultView") || {};
  ...
  onShareAppMessage() {
    const t = String(this.data.tierLabel || '').trim() || '抑郁型人格倾向筛查';
    return {
      title: `我的筛查结果：${t}`,
      path: '/pages/depd/index',
      imageUrl: SHARE_IMG,
    };
  },
  ...
  goRetest() {
    wx.redirectTo({ url: "/pages/depd/index" });
  },
